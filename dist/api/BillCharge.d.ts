...
*/
export declare function getUserChargesMetadata<TResult>(parameters: IGetUserChargesMetadataParameters): Bluebird<IStandardResponse<TResult, IGetUserChargesMetadataParameters>>;
/**
...
*/
export declare function findAllUserCharges<TResult>(parameters: IFindAllUserChargesParameters): Bluebird<IStandardResponse<TResult, IFindAllUserChargesParameters>>;
